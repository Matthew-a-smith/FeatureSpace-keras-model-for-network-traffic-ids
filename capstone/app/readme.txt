...
to make things more easy and streamline the process I created a config.yaml file to adjusit the values from the model along with the file,
...
First I would gather the data typiclally just in wireshark with a single address being monitored and just capture the nmap scan,
